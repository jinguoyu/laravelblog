                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>@foreach($data as $v)
                                    <tr>
                                        <td class="tc">
                                            <input type="text" name="order" value="{{$v['cat_order']}}" onchange="orderchang(this,{{$v['cat_id']}})">
                                        </td>
                                        <td>{{$v['cat_id']}}</td>
                                        <td style="text-align:left">{{$v['cat_name']}}</td>
                                        <td>{{$v['cat_view']}}</td>
                                        <td> <a href="{{url('admin/category/'.$v['cat_id'].'/edit')}}">修改</a>
                                            <a href="javascript:;" onclick="delcate({{$v['cat_id']}},'{{$v['cat_name']}}')">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
